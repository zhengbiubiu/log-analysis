...
public class ConsumerThread implements Runnable {
    ...
    private static String hdfsBasicPath = "hdfs://192.168.10.135:9000/user/atguigu/0115data/";

    @Override
    public void run() {
        // 创建配置
        Properties properties = new Properties();
        properties.put("zookeeper.connect", "192.168.10.135:2181");
        ...
        try {
            // 获取HDFS文件系统
            fs = FileSystem.get(new URI("hdfs://192.168.10.135:9000"), configuration, "atguigu");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        topicCount.put("analysis-0115", 1);
        ...
        KafkaStream<byte[], byte[]> stream = consumerMap.get("analysis-0115").get(0);
