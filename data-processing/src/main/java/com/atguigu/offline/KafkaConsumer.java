...
public class KafkaConsumer {
    ...
    private static String hdfsBasicPath = "hdfs://hadoop101:9000/app-project/";

    public static void main(String[] args) {
        // 创建配置
        Properties properties = new Properties();
        properties.put("zookeeper.connect", "192.168.10.101:2181");
        ...
        try {
            // 获取HDFS文件系统
            fs = FileSystem.get(new URI("hdfs://hadoop101:9000"), configuration, "zhengbiubiu");
        } catch (Exception e) {
            e.printStackTrace();
        }
